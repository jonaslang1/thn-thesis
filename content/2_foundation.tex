\usepackage{glossaries}\chapter{Grundlagen}\label{ch:foundation}
...
Solche Praktiken und Tools werden unter dem Begriff \gls{\gls{DevOps}} zusammengefasst.
...
Diese Automatisierungen werden mithilfe von \gls{CI}/\gls{CD}-\gls{Pipelines} orchestriert, die den gesamten Prozess von der Codeänderung bis zur Bereitstellung steuern.
